...
//        Jedis jedis = new Jedis("10.60.54.229",6379);//8grvTlOPImGRdgPp
        ...
        jedisClusterNodes.add(new HostAndPort("10.60.58.165", 8051));
...
//        JedisCluster jc = new JedisCluster(jedisClusterNodes,2000,2000,3,"8grvTlOPImGRdgPp",new GenericObjectPoolConfig());
        JedisCluster jc = new JedisCluster(jedisClusterNodes,2000,2000,3,"Lsjrxd",new GenericObjectPoolConfig());
        jc.set("foo1", "bar1");
